...
async def sample_config(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    explanation_message = (
        "📂 *Sample submission_config.json*\n\n"
        "This is an example of a valid `submission_config.json`. This file must be included:\n"
        ...
        "3️⃣ **`ALLOW_WARNINGS`**: Whether warnings during compilation are acceptable.\n"
        "4️⃣ **`ALLOW_ERRORS`**: Whether errors during compilation are acceptable.\n"
        "5️⃣ **`contest_id`**: The OIOIOI contest ID for submission.\n"
        "6️⃣ **`problem_short_name`**: The problem's short name in OIOIOI.\n"
        "7️⃣ **`zip_files`**: A list of specifications for generating ZIP files. Each entry includes:\n"
        "    • **`zip_name`**: The name of the ZIP file to generate.\n"
        "    • **`include_paths`**: A list of mappings:\n"
        ...
        "9️⃣ **`auto_merge_branch`**: The branch into which passing submissions are automatically merged.\n\n"
